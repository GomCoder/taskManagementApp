package com.taskmanagement.infrastructure.mail;

import com.taskmanagement.domain.common.mail.SimpleMessage;
...
public class AsyncMailerTest {
  ...
  public void send_validMessage_shouldSucceed() {
    ...
    String to = "console.output@test.com";
    String subject = "A test message";
    String body = "Username: test, Email Address: test@test.com";
    ...
    simpleMailMessage.setText("Username: test, Email Address: test@test.com");
