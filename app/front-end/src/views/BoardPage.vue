...
export default {
  ...
  mounted () {
    ...
    $('#cardModal').on('hide.bs.modal', () => {
      this.$router.replace({ name: 'board', params: { boardId: `${this.board.id}` } })
    })
  },
  beforeDestroy () {
